...
export function generatePromptPaint(paint) {
  return `The subject will be includes a variety of painting art, beautiful landscape, amazing color ,using the style of Edouard Manet, Rembrandt Harmenszoon van Rijn.  ${paint} is his name`;
}
